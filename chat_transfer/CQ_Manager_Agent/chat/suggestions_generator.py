# CQ_Manager_Agent/chat/suggestions_generator.py
import os
from CQ_Manager_Agent.chat.llm_handler import LLMHandler
from CQ_Manager_Agent.chat.document_processor import DocumentProcessor
from CQ_Manager_Agent.config import Config
